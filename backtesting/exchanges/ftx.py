...
class FtxClient:
    ...
    def _make_request(self, endpoint: str, query_parameters: typing.Dict):
        ...
        if response.status_code == 200:
            ...
            if json_response['success']:
                ...
                logger.error('Error while making request to %s: %s (status code = %s)', endpoint, json_response,
                             response.status_code)
                return None

    def _get_symbols(self) -> typing.List[str]:
    ...
    def get_historical_data(self, symbol: str, start_time: typing.Optional[int] = None, end_time: typing.Optional[int] = None):
        params = dict()
        ...
        if raw_candles is not None:
            for c in raw_candles:
                ...
                candles.append((ts, c['open'], c['high'], c['low'], c['open'], c['volume'],))
            return candles
        else:
            return None
