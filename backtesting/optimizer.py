...
import strategies.suport_resistance
import copy
...
class Nsga2:
    ...
    def non_dominated_sorting(self, population: typing.Dict[int, BacktestResult]) -> typing.List[typing.List[BacktestResult]]:
        ...
        for id_1, indiv_1 in population.items():
            for id_2, indiv_2 in population.items():
                if indiv_1.pnl >= indiv_2.pnl and indiv_1.max_dd <= indiv_2.max_dd and (indiv_1.pnl > indiv_2.pnl or
                                                                                        indiv_1.max_dd < indiv_2.max_dd):
                    indiv_1.dominates.append(id_2)

                elif indiv_2.pnl >= indiv_1.pnl and indiv_2.max_dd <= indiv_1.max_dd and (indiv_2.pnl > indiv_1.pnl or
                                                                                          indiv_2.max_dd < indiv_1.max_dd):
    ...
    def evaluate_population(self, population: typing.List[BacktestResult]) -> typing.List[BacktestResult]:
        if self.strategy == 'obv':
            ...
            for bt in population:
                bt.pnl, bt.max_dd = strategies.suport_resistance.backtest(self.data, min_points=bt.parameters['min_points'],
